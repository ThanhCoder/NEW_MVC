                        ...
                        <?php 
                         if(isset($_POST['buttonins'])){
                            ...
                            else
                            {
			                    ...
			                    while ($row5s=mysqli_fetch_array($row5)) {
				            ?>
							<div class="col-lg-4 col-md-4 col-sm-6">
								<div class="f_p_item">
									<div class="f_p_img">
                                    <img class="img-fluid" src="Views/listashop/img/product/feature-product/<?php echo $row5s['image']?>">
										<div class="p_icon">
											<a href="#"><i class="lnr lnr-heart"></i></a>
											<a href="#"><i class="lnr lnr-cart"></i></a>
										</div>
									</div>
									<a href="#"><h4><?php echo $row5s['name'] ?></h4></a>
									<h5><?php echo $row5s['price']?></h5>
								</div>
                            </div> 
                            <?php
                                }
                        ...
                        <aside class="left_widgets cat_widgets">
        						...
        						<div class="widgets_inner">
                                    ...
                                    <?php 
                                     ...
                                     ?>
                                        <li class="active"><a href="/../Project_SmartOSC123/?controller=homewhite"><?php echo $row2s['type_cate'] ?></a></li>
                                        </li>
                                        <?php
			                                }
                                        ?>
